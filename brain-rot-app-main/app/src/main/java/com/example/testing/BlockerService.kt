...
class BlockerService : Service() {
                ...
                if (limit > 0) {
                    ...
                    if (usedMinutes >= limit) {
                        ...
                        if (!blockingInProgress) {
                            ...
                            handler.post {
                                Toast.makeText(this, "Stay focused! Time limit already reached.", Toast.LENGTH_SHORT).show()
                            }
                            redirectToHome()
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                val channel = NotificationChannel(
                    ...
                    description = "Notifications to help you stay motivated and focused"
    ...
    private fun showPersistentBlockingReminder() {
        try {
            ...
            val reminderNotification = NotificationCompat.Builder(this, "blocking_channel")
                ...
                .setContentText("Time limit is active. Focus on your goals instead!")
    ...
    private fun startForegroundServiceWithNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(channelId, "MOTIVASH Service", NotificationManager.IMPORTANCE_LOW)
            val manager = getSystemService(NotificationManager::class.java)
            manager.createNotificationChannel(channel)
        }
        val notification: Notification = NotificationCompat.Builder(this, channelId)
            .setContentTitle("MOTIVASH Active")
            .setContentText("Helping you stay focused and motivated!")
